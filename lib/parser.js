...
var REGEXES = {
  ...
  separator : [
    ...
    /^\s*-{8,10}\s*Forwarded message\s*-{8,10}\s*/m, // Gmail (all locales), Missive (en)
  ...
  original_subject : [
    /^\*?Subject\s?:\*?(.+)/im, // Apple Mail (en), Gmail (all locales), Outlook Live / 365 (all locales), New Outlook 2019 (en), Thunderbird (da, en), Missive (en)
  ...
  original_from : [
    /^(\*?\s*From\s?:\*?(.+))$/m, // Apple Mail (en), Outlook Live / 365 (all locales), New Outlook 2019 (en), Thunderbird (da, en), Missive (en)
  ...
  original_to : [
    /^\*?\s*To\s?:\*?(.+)$/m, // Apple Mail (en), Gmail (all locales), Outlook Live / 365 (all locales), Thunderbird (da, en), Missive (en)
  ...
  original_cc : [
    /^\*?\s*Cc\s?:\*?(.+)$/m, // Apple Mail (en, da, es, fr, hr, it, pt, pt-br, ro, sk), Gmail (all locales), Outlook Live / 365 (all locales), New Outlook 2019 (da, de, en, fr, it, pt-br), Missive (en)
  ...
  original_date : [
    /^\s*Date\s?:(.+)$/m, // Apple Mail (en, fr), Gmail (all locales), New Outlook 2019 (en, fr), Thunderbird (da, en, fr), Missive (en)
...
class Parser {
  ...
  parseBody(body, forwarded = false) {
    ...
    if (forwarded === true) {
      ...
      if (_match && _match.length > 3) {
        // The From has been detached by the `split` operation, attach it back
  ...
  __parseOriginalBody(text) {
    ...
    //   (Apple Mail, Gmail) or after the Subject part (Outlook Live / 365)
    var _regexes = [
  ...
  __parseOriginalFrom(text, body) {
    ...
    if (Array.isArray(_author) && _author[0].address) {
      return _author[0];
    }
