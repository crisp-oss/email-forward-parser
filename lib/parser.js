...
var RE2                                      = require("re2");
var { loopRegexes, trimString, cleanString } = require("./utils");
      ...
      if (_mailboxesLine) {
        ...
        for (var _i = 0; _i < _mailboxes.length; _i++) {
          ...
          if (_nameAddressMatch && _nameAddressMatch.length > 0) {
            var _address = cleanString(_nameAddressMatch[2]);
            var _name = cleanString(_nameAddressMatch[1]);
            ...
            _mailboxes[_i] = {
              address : cleanString(_mailboxes[_i]),
              name    : null
            };
          }
        }
